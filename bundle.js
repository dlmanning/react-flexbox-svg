...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testJs = __webpack_require__(174);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(_testJs2['default'], null);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMClient = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wolfy87Eventemitter = __webpack_require__(185);
	...
	var Container = (function (_Component) {
	  ...
	  Container = composeWith(_flex.FlexBox)(Container) || Container;
	  return Container;
	})(_react.Component);
	...
	var Circle = (function (_Component2) {
	  function Circle() {
	    ...
	    _get(Object.getPrototypeOf(_Circle.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(_Circle, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('circle', { style: this.props.style, cx: '40', cy: '40', r: '40' });
	    }
	  }]);

	  Circle = composeWith(_flex.FlexBox)(Circle) || Circle;
	  return Circle;
	})(_react.Component);

	var Thing = (function (_Component3) {
	  function Thing() {
	    _classCallCheck(this, Thing);

	    _get(Object.getPrototypeOf(Thing.prototype), 'constructor', this).apply(this, arguments);
	  ...
	  _createClass(Thing, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      setInterval(function () {
	        var width = 275 * Math.cos(++t / (8 * Math.PI)) + 425;
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _flex.FlexContext,
	          null,
	          _react2['default'].createElement('rect', { height: height - 1, width: width - 1, style: { fill: 'lightgrey', stroke: 'black' } }),
	          _react2['default'].createElement(
	            Container,
	            { style: containerStyle },
	            Thing.colors.map(function (color, idx) {
	              return _react2['default'].createElement(Circle, { style: _extends({ fill: color }, circleStyle), key: idx });
	            })
	          )
	        )
	      );
	    ...
	    key: 'colors',
	    value: (function (n) {
	      var totalColors = Math.pow(256, 3);
	      var stepSize = Math.floor(totalColors / n);
	      var colorValues = [];
	      ...
	      return colorValues.map(function (value) {
	        return rgb(value);
	      });
	      ...
	      function rgb(value) {
	        ...
	        for (var i = 0; i < 3; i++) {
	          digits[i] = Math.floor(value / Math.pow(256, 2 - i));
	          value %= Math.pow(256, 2 - i);
	        }
	...
	function composeWith() {
	  ...
	  return function (target) {
	    return hocs.reduce(function (composite, hoc) {
	      return hoc(composite);
	    }, target);
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectWithoutProperties = __webpack_require__(182)['default'];
	...
	var _cssLayout = __webpack_require__(186);

	var _cssLayout2 = _interopRequireDefault(_cssLayout);

	var _flexboxProps = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Set = __webpack_require__(189)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.2 Set Objects
	__webpack_require__(205)('Set', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(4)
	  ...
	  , safe     = __webpack_require__(200).safe
	  , assert   = __webpack_require__(195)
	  , forOf    = __webpack_require__(193)
	  , step     = __webpack_require__(196).step
	  , $has     = $.has
	  , set      = $.set
	  , isObject = $.isObject
	  , hide     = $.hide
	...
	module.exports = {
	  getConstructor: function(wrapper, NAME, IS_MAP, ADDER){
	    ...
	    __webpack_require__(202)(C.prototype, {
	  ...
	  setIter: function(C, NAME, IS_MAP){
	    __webpack_require__(204)(C, NAME, function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx  = __webpack_require__(194)
	  , get  = __webpack_require__(196).get
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertFunction = __webpack_require__(195).fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertObject = __webpack_require__(195).obj;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $     = __webpack_require__(4)
	  ...
	  , BUGGY = $iter.BUGGY
	  , forOf = __webpack_require__(193)
	  , assertInstance = __webpack_require__(195).inst
	  , INTERNAL = __webpack_require__(200).safe('internal');
	...
	module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK){
	  ...
	  if(!$.DESC || !$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)){
	    ...
	    __webpack_require__(202)(C.prototype, methods);
	  } else {
	  ...
	  __webpack_require__(197).set(C, NAME);

	  O[NAME] = C;
	  $def($def.G + $def.W + $def.F, O);
	  __webpack_require__(206)(C);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(__webpack_require__(4).FW && cof(tmp) != 'z'){
	  __webpack_require__(203)(Object.prototype, 'toString', function toString(){
